...
async fn main() {
    ...
    let shopping_list_items_route = warp::path("shopping_list_item")
        .and(warp::get())
...
// curl -X POST 'localhost:8000/shopping_list_item' -H "Content-Type: application/json" -d '{"name": "peanut butter", "item_type": "spread", "description": "made from peanuts", "price": 2.5}'